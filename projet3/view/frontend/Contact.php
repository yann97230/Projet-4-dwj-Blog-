		...
		<div class="heading">
			...
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1">
					<form id="contact-form" method="post" action="index.php?action=Contact" roles="form">
						<div class="row">
							...
							<div class="col-md-12">
								<input type="submit" name="submit" class="button1" action="index.php?action=contact.php" value="Envoyer">
							</div>
						</div>
					</form>
				</div>
