        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3 login-content pb-5 px-5">
                <div class="backgroundNew">
                    <form id="form-login"  action="index.php?action=connexion" method="post">
                        ...
                        <div class="text-center" id="formconnect">
                            <input type="submit" name="submit" action="index.php?action=connexion" class="btn btn-primary mt-3 float-none float-md-right" Value="connexion">
                        </div>
                    </form>
                </div>    
            </div>
