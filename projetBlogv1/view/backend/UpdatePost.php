...
<?php foreach ($articles as $article) { ?>
    <div id="addupdatepost">
        ...
        <button class="btn btn-info"><a href="index.php?action=indexView">Retour à la liste des Articles</a></button>
    <div>
...
<div id="form"> 
    <form class="commentaire" action="index.php?action=editArticle&amp;postId=<?=$article->getId() ?>" method="post">
        <div>
