...
<?php if (isset($_SESSION['admin'])): ?>
   <div id="button-indexview"> 
        <div id="addArticle"><button class="btn btn-info"><a href="index.php?action=formPost">Ajouter un article</a></button></div>
    <?php else: ?>  
        <br><br>
<?php endif; ?>
    ...
    <div class="news">
        <div class="backgroundNew">
            <article class="contenair">   
                ...
                <br />
                <em><button id="boutonPost" class="btn btn-info"><a class="button-return" href="index.php?action=post&amp;id=<?= $article->getId() ?>">Ajouter un commentaires</a></button></em>
                </p>
            </article>     
        </div>
    </div>
